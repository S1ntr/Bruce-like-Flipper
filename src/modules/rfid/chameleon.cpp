...
void Chameleon::readed_data_block() {
    tft.fillScreen(bruceConfig.bgColor);
    tft.drawBitmap(159, 54, image_download_bits, 160, 116, bruceConfig.priColor);
    tft.setTextColor(bruceConfig.priColor);
    tft.setTextSize(2);
    // tft.setFreeFont();
    tft.drawString("Sucessfully", 13, 38);
    tft.drawString("readed RFID", 13, 58);
}
